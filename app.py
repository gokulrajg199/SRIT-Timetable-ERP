...
def header():
    ...
    with cols[1]:
        ...
        <div class='main-header'>
            ...
            <h3>Academic Timetable & Resource Management System</h3>
            <p>Faculty • Year • Section • Classroom • Laboratory • Theory + Lab • Clash-Free Scheduler</p>
        </div>
